...
var POLL_LOW = exports.POLL_LOW = 0x1;	/* Falling edge detect */
var POLL_HIGH = exports.POLL_HIGH = 0x2;	/* Rising edge detect */
var POLL_BOTH = exports.POLL_BOTH = 0x3;	/* POLL_LOW | POLL_HIGH */


var TMP_GPIO_DIR = '/tmp/gpio';
 ...
 * actions.
 *
 * @name caf_rpi_gpio/mock_gpio
 * @namespace
 * @augments caf_iot/gen_plug_iot
 *
 */

var dumpMeta = function() {
...
exports.poll = function(pin, callback, trigger) {
    ...
    if (callback === null) {
        ...
        var lastValue = null;
        var f = function(curr, prev) {
            if (curr.mtime !== prev.mtime) {
                var current = read(pin);
...
var read = exports.read = function(pin) {
